...
export const options = {
  stages: [
    { duration: "5s", target: 100 }, // calentar con 100 usuarios durante 5 segundos
    { duration: "10s", target: 200 }, // incrementar a 200 usuarios durante 10 segundos
  ],
};
...
export default function () {
  const res = http.get(
    "https://sharp-lisa-jhonmata0427s-projects-a5f958cc.koyeb.app/api/v1/conferencistas",
    {
      headers: {
